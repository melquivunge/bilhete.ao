...
<head>
    ...
    <!-- Style sheets-->
    {{--
        A fonte externa (fonts.bunny.net) foi removida deste layout.

        O Horizon pedia-a a um terceiro em cada carregamento do painel, o que faz
        o IP e o referer de cada membro do staff saírem da plataforma sem
        necessidade. É o mesmo problema que o provedor de avatar do Filament tinha
        com ui-avatars.com (KI-018), e foi descoberto da mesma forma: pelo CSP a
        bloquear o pedido.

        O painel usa a pilha de fontes do sistema. Autorizar o domínio no CSP
        teria calado o sintoma e mantido a chamada.
    --}}
    <style>
        :root { --horizon-font-sans: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif; }
        body, .font-sans { font-family: var(--horizon-font-sans) !important; }
    </style>
