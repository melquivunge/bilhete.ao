...
| ADR-005 | Inertia e Vue no frontend | Reservado | C0.4 |
...
ADR-005 tratará da forma concreta de estruturar o frontend e será escrito em C0.4,
que é onde essa decisão passa a ser executada — não um marco depois.
